 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new hn("@firebase/app"),Cn="@firebase/app-compat",Dn="@firebase/analytics-compat",kn="@firebase/analytics",On="@firebase/app-check-compat",Bn="@firebase/app-check",Nn="@firebase/auth",Mn="@firebase/auth-compat",Rn="@firebase/database",Ln="@firebase/data-connect",Pn="@firebase/database-compat",$n="@firebase/functions",Fn="@firebase/functions-compat",xn="@firebase/installations",jn="@firebase/installations-compat",Hn="@firebase/messaging",Un="@firebase/messaging-compat",Vn="@firebase/performance",Wn="@firebase/performance-compat",Kn="@firebase/remote-config",zn="@firebase/remote-config-compat",qn="@firebase/storage",Gn="@firebase/storage-compat",Jn="@firebase/firestore",Yn="@firebase/vertexai",Xn="@firebase/firestore-compat",Zn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G=new Map,er=new Map,he=new Map;function Me(e,t){try{e.container.addComponent(t)}catch(n){E.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function k(e){const t=e.name;if(he.has(t))return E.debug(`There were multiple attempts to register component ${t}.`),!1;he.set(t,e);for(const n of G.values())Me(n,e);for(const n of er.values())Me(n,e);return!0}function we(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nr{constructor(t,n,r){this._isDeleted=!1,this._options=Object.assign({},t),this._config=Object.assign({},n),this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new A("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw v.create("app-deleted",{appName:this._name})}}function rt(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:pe,automaticDataCollectionEnabled:!1},t),i=r.name;if(typeof i!="string"||!i)throw v.create("bad-app-name",{appName:String(i)});if(n||(n=Ze()),!n)throw v.create("no-options");const o=G.get(i);if(o){if(le(n,o.options)&&le(r,o.config))return o;throw v.create("duplicate-app",{appName:i})}const a=new ln(i);for(const c of he.values())a.addComponent(c);const s=new nr(n,r,a);return G.set(i,s),s}function rr(e=pe){const t=G.get(e);if(!t&&e===pe&&Ze())return rt();if(!t)throw v.create("no-app",{appName:e});return t}function S(e,t,n){var r;let i=(r=Qn[e])!==null&&r!==void 0?r:e;n&&(i+=`-${n}`);const o=i.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const s=[`Unable to register library "${i}" with version "${t}":`];o&&s.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&a&&s.push("and"),a&&s.push(`version name "${t}" contains illegal characters (whitespace or "/")`),E.warn(s.join(" "));return}k(new A(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir="firebase-heartbeat-database",or=1,H="firebase-heartbeat-store";let re=null;function it(){return re||(re=W(ir,or,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(H)}catch(n){console.warn(n)}}}}).catch(e=>{throw v.create("idb-open",{originalErrorMessage:e.message})})),re}async function ar(e){try{const n=(await it()).transaction(H),r=await n.objectStore(H).get(ot(e));return await n.done,r}catch(t){if(t instanceof $)E.warn(t.message);else{const n=v.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});E.warn(n.message)}}}async function Re(e,t){try{const r=(await it()).transaction(H,"readwrite");await r.objectStore(H).put(t,ot(e)),await r.done}catch(n){if(n instanceof $)E.warn(n.message);else{const r=v.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});E.warn(r.message)}}}function ot(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut({projectId:e}){return`${mr}/projects/${e}/installations`}function ft(e){return{token:e.token,requestStatus:2,expiresIn:_r(e.expiresIn),creationTime:Date.now()}}async function pt(e,t){const r=(await t.json()).error;return O.create("request-failed",{requestName:e,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})}function ht({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Er(e,{refreshToken:t}){const n=ht(e);return n.append("Authorization",vr(t)),n}async function gt(e){const t=await e();return t.status>=500&&t.status<600?e():t}function _r(e){return Number(e.replace("s","000"))}function vr(e){return`${lt} ${e}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ee(e){let t;const n=await Z(e.appConfig,r=>{const i=Rr(r),o=Lr(e,i);return t=o.registrationPromise,o.installationEntry});return n.fid===ge?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Rr(e){const t=e||{fid:Cr(),registrationStatus:0};return Et(t)}function Lr(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(O.create("app-offline"));return{installationEntry:t,registrationPromise:i}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Pr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:$r(e)}:{installationEntry:t}}async function Pr(e,t){try{const n=await Sr(e,t);return J(e.appConfig,n)}catch(n){throw dt(n)&&n.customData.serverCode===409?await It(e.appConfig):await J(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function $r(e){let t=await $e(e.appConfig);for(;t.registrationStatus===1;)await mt(100),t=await $e(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await Ee(e);return r||n}return t}function $e(e){return Z(e,t=>{if(!t)throw O.create("installation-not-found");return Et(t)})}function Et(e){return Fr(e)?{fid:e.fid,registrationStatus:0}:e}function Fr(e){return e.registrationStatus===1&&e.registrationTime+st<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xr({appConfig:e,heartbeatServiceProvider:t},n){const r=jr(e,n),i=Er(e,n),o=t.getImmediate({optional:!0});if(o){const l=await o.getHeartbeatsHeader();l&&i.append("x-firebase-client",l)}const a={installation:{sdkVersion:ct,appId:e.appId}},s={method:"POST",headers:i,body:JSON.stringify(a)},c=await gt(()=>fetch(r,s));if(c.ok){const l=await c.json();return ft(l)}else throw await pt("Generate Auth Token",c)}function jr(e,{fid:t}){return`${ut(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qr(e){const t=e,{installationEntry:n,registrationPromise:r}=await Ee(t);return r?r.catch(console.error):_e(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gr(e,t=!1){const n=e;return await Jr(n),(await _e(n,t)).token}async function Jr(e){const{registrationPromise:t}=await Ee(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt="installations",Xr="installations-internal",Zr=e=>{const t=e.getProvider("app").getImmediate(),n=Yr(t),r=we(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Qr=e=>{const t=e.getProvider("app").getImmediate(),n=we(t,vt).getImmediate();return{getId:()=>qr(n),getToken:i=>Gr(n,i)}};function ei(){k(new A(vt,Zr,"PUBLIC")),k(new A(Xr,Qr,"PRIVATE"))}ei();S(at,ye);S(at,ye,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wi=7*24*60*60*1e3;async function yi(e){const t=await Ei(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:y(t.getKey("auth")),p256dh:y(t.getKey("p256dh"))},r=await pi(e.firebaseDependencies);if(r){if(_i(r.subscriptionOptions,n))return Date.now()>=r.createTime+wi?Ii(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await bi(e.firebaseDependencies,r.token)}catch(i){console.warn(i)}return Ue(e.firebaseDependencies,n)}else return Ue(e.firebaseDependencies,n)}async function Ii(e,t){try{const n=await mi(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await ve(e.firebaseDependencies,r),n}catch(n){throw n}}async function Ue(e,t){const r={token:await gi(e,t),createTime:Date.now(),subscriptionOptions:t};return await ve(e,r),r.token}async function Ei(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:si(t)})}function _i(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,i=t.auth===e.auth,o=t.p256dh===e.p256dh;return n&&r&&i&&o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
