 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v=new hn("@firebase/app"),Cn="@firebase/app-compat",Dn="@firebase/analytics-compat",kn="@firebase/analytics",On="@firebase/app-check-compat",Bn="@firebase/app-check",Nn="@firebase/auth",Mn="@firebase/auth-compat",Rn="@firebase/database",Ln="@firebase/data-connect",Pn="@firebase/database-compat",$n="@firebase/functions",Fn="@firebase/functions-compat",xn="@firebase/installations",jn="@firebase/installations-compat",Hn="@firebase/messaging",Un="@firebase/messaging-compat",Wn="@firebase/performance",Vn="@firebase/performance-compat",Kn="@firebase/remote-config",zn="@firebase/remote-config-compat",qn="@firebase/storage",Gn="@firebase/storage-compat",Jn="@firebase/firestore",Yn="@firebase/vertexai",Xn="@firebase/firestore-compat",Zn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe="[DEFAULT]",Qn={[fe]:"fire-core",[Cn]:"fire-core-compat",[kn]:"fire-analytics",[Dn]:"fire-analytics-compat",[Bn]:"fire-app-check",[On]:"fire-app-check-compat",[Nn]:"fire-auth",[Mn]:"fire-auth-compat",[Rn]:"fire-rtdb",[Ln]:"fire-data-connect",[Pn]:"fire-rtdb-compat",[$n]:"fire-fn",[Fn]:"fire-fn-compat",[xn]:"fire-iid",[jn]:"fire-iid-compat",[Hn]:"fire-fcm",[Un]:"fire-fcm-compat",[Wn]:"fire-perf",[Vn]:"fire-perf-compat",[Kn]:"fire-rc",[zn]:"fire-rc-compat",[qn]:"fire-gcs",[Gn]:"fire-gcs-compat",[Jn]:"fire-fst",[Xn]:"fire-fst-compat",[Yn]:"fire-vertex","fire-js":"fire-js",[Zn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sr({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=ut(e),i=ht(e),o=t.getImmediate({optional:!0});if(o){const d=await o.getHeartbeatsHeader();d&&i.append("x-firebase-client",d)}const a={fid:n,authVersion:lt,appId:e.appId,sdkVersion:ct},s={method:"POST",headers:i,body:JSON.stringify(a)},c=await gt(()=>fetch(r,s));if(c.ok){const d=await c.json();return{fid:d.fid||n,registrationStatus:2,refreshToken:d.refreshToken,authToken:ft(d.authToken)}}else throw await pt("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xr({appConfig:e,heartbeatServiceProvider:t},n){const r=jr(e,n),i=vr(e,n),o=t.getImmediate({optional:!0});if(o){const d=await o.getHeartbeatsHeader();d&&i.append("x-firebase-client",d)}const a={installation:{sdkVersion:ct,appId:e.appId}},s={method:"POST",headers:i,body:JSON.stringify(a)},c=await gt(()=>fetch(r,s));if(c.ok){const d=await c.json();return ft(d)}else throw await pt("Generate Auth Token",c)}function jr(e,{fid:t}){return`${ut(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ui="firebase-messaging-database",fi=1,W="firebase-messaging-store";let se=null;function Tt(){return se||(se=V(ui,fi,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(W)}}})),se}async function pi(e){const t=Ct(e),r=await(await Tt()).transaction(W).objectStore(W).get(t);if(r)return r;{const i=await li(e.appConfig.senderId);if(i)return await _e(e,i),i}}async function _e(e,t){const n=Ct(e),i=(await Tt()).transaction(W,"readwrite");return await i.objectStore(W).put(t,n),await i.done,t}function Ct({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Li(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===U.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(We(n)):e.onMessageHandler.next(We(n)));const r=n.data;Ti(r)&&r[ai]==="1"&&await Mi(e,n.messageType,r)}const Ve="@firebase/messaging",Ke="0.12.17";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hi(e=rr()){return xi().then(t=>{if(!t)throw m.create("unsupported-browser")},t=>{throw m.create("indexed-db-unsupported")}),we(me(e),"messaging").getImmediate()}async function Ui(e,t){return e=me(e),kt(e,t)}function Wi(e,t){return e=me(e),ji(e,t)}Fi();const Vi={apiKey:"AIzaSyAGHLS1hwXIu7v8EYGHqc320wdwmfZpkj0",authDomain:"pwa-g9-2025.firebaseapp.com",projectId:"pwa-g9-2025",storageBucket:"pwa-g9-2025.firebasestorage.app",messagingSenderId:"619074453275",appId:"1:619074453275:web:853ca8640be57379015dbe",measurementId:"G-ED9XNMQSBZ"},Ki=rt(Vi),Ot=Hi(Ki);async function zi(){try{const e=await navigator.serviceWorker.register("/2025-1-s1-g9-t2/sw.js"),t=await Ui(Ot,{vapidKey:"BK5dG7X9LrsGL2toqXYmZ2gaGc_V78EnHog8ZiggCB3gzL2iIguzVouD1coi_24mJQT1HHfIcXCWsZ3iEqIf6JY",serviceWorkerRegistration:e});console.log("Token de cliente:",t)}catch(e){console.error("No se pudo obtener token:",e)}}function qi(){Wi(Ot,e=>{console.log("Notificación en primer plano:",e),Notification.permission==="granted"&&new Notification(e.notification.title,{body:e.notification.body,icon:"/2025-1-s1-g9-t2/iconLogo.png"})})}const M=V("image-editor-db",1,{upgrade(e){if(e.objectStoreNames.contains("originalImages")||e.createObjectStore("originalImages",{keyPath:"id",autoIncrement:!0}).createIndex("timestamp","timestamp"),!e.objectStoreNames.contains("imageFilters")){const t=e.createObjectStore("imageFilters",{keyPath:"id",autoIncrement:!0});t.createIndex("imageId","imageId"),t.createIndex("timestamp","timestamp")}}});async function Gi(e){try{const t=await M;if(!t)throw new Error("Failed to open IndexedDB.");const n=await t.add("originalImages",{image:e,timestamp:Date.now()});return console.log("Image saved with ID:",n),n}catch(t){throw console.error("Error in saveOriginalImage:",t),t}}async function Ji(e,t=[]){return await(await M).add("imageFilters",{imageId:e,filters:t,timestamp:Date.now()})}async function Yi(){const e=await M;let t=await e.getAll("originalImages");return t.sort((r,i)=>i.timestamp-r.timestamp),await Promise.all(t.map(async r=>{const i=await e.getAllFromIndex("imageFilters","imageId",r.id);return{image:r,filters:i.length>0?i[0].filters:[]}}))}async function ze(e,t){try{const i=(await M).transaction(["imageFilters"],"readwrite").objectStore("imageFilters"),a=(await i.getAll()).find(s=>s.imageId===e);a?(a.filters=t,await i.put(a),console.log(`Filters updated successfully for image ID ${e}`),console.log(t)):(await i.add({imageId:e,filters:t}),console.log(`Created new filter entry for image ID ${e}`))}catch(n){throw console.error("Error in updateImageFilters:",n),n}}async function Xi(e){const n=(await M).transaction("originalImages","readwrite");await n.objectStore("originalImages").delete(e),await n.done}async function Zi(){const t=(await M).transaction("originalImages","readwrite");await t.objectStore("originalImages").clear(),await t.done}async function Qi(){return await(await M).count("originalImages")===0}async function eo(){await Ge();const e=document.getElementById("imageInput"),t={resize:document.getElementById("resizeButton"),grayscale:document.getElementById("grayscaleButton"),blur:document.getElementById("blurButton"),flip:document.getElementById("flipButton"),pixelate:document.getElementById("pixelateButton"),invert:document.getElementById("invertButton"),download:document.getElementById("downloadButton"),reset:document.getElementById("resetButton")};let n=null,r=null,i=null,o=[];e.addEventListener("change",async()=>{const l=e.files[0];if(l){const g=await l.arrayBuffer();r=new Uint8Array(g),n=new Uint8Array(g),o=[];const h=await Gi(new Blob([r],{type:l.type}));i=h,Ji(h,o),d(n),s("reset")}});const a=async(l=null)=>{if(l){let{image:g,filters:h}=l;const E=await g.image.arrayBuffer();l=new Uint8Array(E);for(const w of h)l=c(l,w);return l}else{if(!r)return;console.log(r),n=new Uint8Array(r),console.log(n),console.log(o);for(const g of o)n=await c(n,g),console.log(g,n);return d(n),n}},s=l=>{if(n){if(l=="reset"){o=[],ze(i,[]),n=new Uint8Array(r),d(n);return}o.includes(l)?o.splice(o.indexOf(l),1):o.push(l),ze(i,o),a()}},c=(l,g)=>{switch(g){case"resize":return Lt(l,200,200);case"grayscale":return Pt(l);case"blur":return $t(l,5);case"flip":return Ft(l);case"pixelate":return xt(l,8);case"invert":return jt(l);default:return console.error(`Unknown filter: ${g}`),l}};t.resize.addEventListener("click",()=>s("resize")),t.grayscale.addEventListener("click",()=>s("grayscale")),t.blur.addEventListener("click",()=>s("blur")),t.flip.addEventListener("click",()=>s("flip")),t.pixelate.addEventListener("click",()=>s("pixelate")),t.invert.addEventListener("click",()=>s("invert")),t.reset.addEventListener("click",()=>s("reset")),"serviceWorker"in navigator?(console.log("Service Worker is supported in this browser"),navigator.serviceWorker.register("/2025-1-s1-g9-t2/sw.js").then(l=>console.log("Service Worker Registered",l)).catch(l=>console.error("Error in SW register",l))):console.log("Service Worker not supported in this browser"),t.download.addEventListener("click",()=>{n&&(u(n,"processed_image.png"),console.log("Service Worker activo"),navigator.serviceWorker.ready.then(l=>{l.active.postMessage({type:"SHOW_NOTIFICATION",title:"Descarga iniciada!!",body:"La imagen procesada se está descargando.",icon:"/2025-1-s1-g9-t2/camIcon192.png"})}))});function d(l,g="image/png"){const h=document.getElementById("outputImage");if(!l||l.length===0){h.style.display="none",h.src="";return}const E=new Blob([l],{type:g}),w=URL.createObjectURL(E);h.src=w,h.style.display="block"}function u(l,g){console.log("Downloading image. Bytes:",l.length);const h=new Blob([l],{type:"image/png"}),E=URL.createObjectURL(h),w=document.createElement("a");w.href=E,w.download=g,w.click(),URL.revokeObjectURL(E)}window.addEventListener("load",()=>{setTimeout(()=>{document.getElementById("splash-screen").style.display="none"},1e3)});const T=document.getElementById("viewUploadsButton"),b=document.getElementById("uploadsModal"),R=document.getElementById("closeUploadsModal");T.addEventListener("click",()=>{b.classList.remove("hidden"),F()}),R.addEventListener("click",()=>{b.classList.add("hidden")}),window.addEventListener("click",l=>{l.target===b&&b.classList.add("hidden")});async function F(){const l=document.getElementById("uploadsGallery");l.innerHTML="";const g=await Yi();for(const h of g){let{filters:E}=h,{id:w}=h.image,Te=await a(h);const Nt=new Blob([Te],{type:"image/png"}),Mt=URL.createObjectURL(Nt),x=document.createElement("div");x.className="thumbnail flex flex-col items-center";const K=document.createElement("img");K.src=Mt,K.alt="Uploaded image",K.className="w-full rounded";const z=document.createElement("button");z.textContent="Load",z.className="mt-2 bg-blue-500 text-white px-3 py-1 rounded",z.onclick=async()=>{i=w,console.log("OG",h.image.image.arrayBuffer()),r=new Uint8Array(await h.image.image.arrayBuffer()),n=new Uint8Array(Te),console.log(n),o=E,d(n),setTimeout(()=>{b.classList.add("hidden")},50)};const q=document.createElement("button");q.innerHTML="🗑️",q.className="absolute top-1 right-1 text-red-500 hover:scale-110 transition",q.onclick=async()=>{await Xi(w),i===w&&(e.value="",n=null,r=null,i=null,o=[]),Qi().then(Rt=>{Rt&&b.classList.add("hidden")}),await F(),d(n)},x.appendChild(q),x.appendChild(K),x.appendChild(z),l.appendChild(x)}}const Bt=document.getElementById("clearImages");Bt.onclick=async()=>{Zi(),e.value="",n=null,r=null,i=null,o=[],setTimeout(()=>{b.classList.add("hidden")},50),d(n)},await F()}zi();qi();eo();
