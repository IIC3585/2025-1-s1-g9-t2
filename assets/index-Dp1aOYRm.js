 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v=new hn("@firebase/app"),Cn="@firebase/app-compat",kn="@firebase/analytics-compat",Dn="@firebase/analytics",On="@firebase/app-check-compat",Bn="@firebase/app-check",Nn="@firebase/auth",Mn="@firebase/auth-compat",Rn="@firebase/database",Ln="@firebase/data-connect",Pn="@firebase/database-compat",$n="@firebase/functions",Fn="@firebase/functions-compat",xn="@firebase/installations",jn="@firebase/installations-compat",Hn="@firebase/messaging",Un="@firebase/messaging-compat",Wn="@firebase/performance",Vn="@firebase/performance-compat",Kn="@firebase/remote-config",zn="@firebase/remote-config-compat",qn="@firebase/storage",Gn="@firebase/storage-compat",Jn="@firebase/firestore",Yn="@firebase/vertexai",Xn="@firebase/firestore-compat",Zn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe="[DEFAULT]",Qn={[fe]:"fire-core",[Cn]:"fire-core-compat",[Dn]:"fire-analytics",[kn]:"fire-analytics-compat",[Bn]:"fire-app-check",[On]:"fire-app-check-compat",[Nn]:"fire-auth",[Mn]:"fire-auth-compat",[Rn]:"fire-rtdb",[Ln]:"fire-data-connect",[Pn]:"fire-rtdb-compat",[$n]:"fire-fn",[Fn]:"fire-fn-compat",[xn]:"fire-iid",[jn]:"fire-iid-compat",[Hn]:"fire-fcm",[Un]:"fire-fcm-compat",[Wn]:"fire-perf",[Vn]:"fire-perf-compat",[Kn]:"fire-rc",[zn]:"fire-rc-compat",[qn]:"fire-gcs",[Gn]:"fire-gcs-compat",[Jn]:"fire-fst",[Xn]:"fire-fst-compat",[Yn]:"fire-vertex","fire-js":"fire-js",[Zn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pr(e){D(new A("platform-logger",t=>new An(t),"PRIVATE")),D(new A("heartbeat",t=>new lr(t),"PRIVATE")),S(fe,Ne,e),S(fe,Ne,"esm2017"),S("fire-js","")}pr("");var hr="firebase",gr="11.6.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=/^[cdef][\w-]{21}$/,ge="";function Cr(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=kr(e);return Tr.test(n)?n:ge}catch{return ge}}function kr(e){return Ar(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt=new Map;function wt(e,t){const n=X(e);yt(n,t),Dr(n,t)}function yt(e,t){const n=bt.get(e);if(n)for(const r of n)r(t)}function Dr(e,t){const n=Or();n&&n.postMessage({key:e,fid:t}),Br()}let k=null;function Or(){return!k&&"BroadcastChannel"in self&&(k=new BroadcastChannel("[Firebase] FID Change"),k.onmessage=e=>{yt(e.data.key,e.data.fid)}),k}function Br(){bt.size===0&&k&&(k.close(),k=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="installations",Xr="installations-internal",Zr=e=>{const t=e.getProvider("app").getImmediate(),n=Yr(t),r=we(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Qr=e=>{const t=e.getProvider("app").getImmediate(),n=we(t,_t).getImmediate();return{getId:()=>qr(n),getToken:i=>Gr(n,i)}};function ei(){D(new A(_t,Zr,"PUBLIC")),D(new A(Xr,Qr,"PRIVATE"))}ei();S(at,ye);S(at,ye,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bi(e,t){if(!t&&!e.swRegistration&&await Di(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw m.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dt(e,t){if(!navigator)throw m.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw m.create("permission-blocked");return await Ni(e,t==null?void 0:t.vapidKey),await Bi(e,t==null?void 0:t.serviceWorkerRegistration),yi(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pi=e=>{const t=new ki(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>Li(t,n)),t},$i=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>Dt(t,r)}};function Fi(){D(new A("messaging",Pi,"PUBLIC")),D(new A("messaging-internal",$i,"PRIVATE")),S(Ve,Ke),S(Ve,Ke,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
